...
## Windows
Töltsük le a [python.org/downloads](https://www.python.org/downloads/) link alól a legutolsó Windowsos verziót (pl. `3.6.5`)
...
Ezután `F5` billentyűvel vagy a beépülő terminálban futtathatóak lesznek a kódjaink.
